...
finding = True
while finding:
    uIn = input("Please enter the room name (minus extensions): ")

    if not os.path.isfile(uIn+".room.gmx"):
...
finding = True
while finding:
    uIn = input("Would you like to move objects made in the room editor? ")
...
finding = True
while finding:
    uIn = input("Would you like to move tiles made in the room editor? ")
    if uIn in ("Yes", "yes", "y", "1"):
        tiles = True
        finding = False
...
finding = True
while finding:
    uIn = input("Please enter the x amount to move (positive is to the right): ")
    if uIn == "0":
        x = 0
        finding = False
    else:
